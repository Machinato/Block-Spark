...
import { lerpC } from '@/lib/prismUtil'
...
export const Box = forwardRef((props, ref) => {
  ...
  // useFrame(() => {
  //   lerpC(inner.current.material.emissive, hovered ? '#000000' : '#000000', 0)
  // })
  return (
    <group scale={1} ref={ref} {...props} visible={false}>
      <mesh visible={false} onRayOver={() => hover(true)} onRayOut={() => hover(false)} geometry={boxGeometry} />      <mesh ref={inner} geometry={roundedBoxGeometry}>
        <meshBasicMaterial color="#e20707" />
      </mesh>
    </group>
  )
})
